...
def install():
    ...
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/htmex.sh")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/htcontext.sh")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/mk4ht.pl")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/htxetex.sh")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/httex.sh")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/htlatex.sh")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/ht.sh")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/httexi.sh")
    pisitools.remove("/usr/share/texmf-dist/scripts/tex4ht/htxelatex.sh")
