...
fileassociations.write("x-scheme-handler/mailto=mozillathunderbird.desktop;\n")
fileassociations.write("application/x-extension-eml=mozillathunderbird.desktop;\n")
